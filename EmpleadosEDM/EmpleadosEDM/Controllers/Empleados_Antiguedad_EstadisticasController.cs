...
namespace EmpleadosEDM.Controllers
{
    public class Empleados_Antiguedad_EstadisticasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idAntiguedad,idEmpleado,Nombre,Extra,Bajas_Laborales")] Empleados_Antiguedad_Estadisticas empleados_Antiguedad_Estadisticas)
        {
            ...
            ViewBag.idEmpleado = new SelectList(db.Empleados, "idEmpleado", "Nombre", empleados_Antiguedad_Estadisticas.idEmpleado);
            return View(empleados_Antiguedad_Estadisticas);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idAntiguedad,idEmpleado,Nombre,Extra,Bajas_Laborales")] Empleados_Antiguedad_Estadisticas empleados_Antiguedad_Estadisticas)
        {
            if (ModelState.IsValid)
            {
